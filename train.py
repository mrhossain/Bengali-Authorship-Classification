...
tf.flags.DEFINE_integer("embedding_dim",600, "Dimensionality of character embedding (default: 128)")
tf.flags.DEFINE_string("filter_sizes", "2,3,4", "Comma-separated filter sizes (default: '3,4,5')")
tf.flags.DEFINE_integer("num_filters",170, "Number of filters per filter size (default: 128)")
...
glove_embeddng_path = '/mnt/b7e83844-6bc7-43cd-8eee-87edc0eadf1e/glove/glove/Embedding-News-Corpus-300/vectors.txt'
